	...
	if ($stmt->execute($neighbors)){
		...
		if ($result){
			...
			foreach ($result as $r){
				...
				*/
				echo '<li class="ui-li-has-thumb ui-btn ui-btn-icon-right ui-li ui-btn-up-c" role="option" tabindex="-1" data-theme="c"><div class="ui-btn-inner"><div class="ui-btn-text">';
				echo '<img src="img/avatars/'.$r['avatar'].'" class="ui-li-thumb">';
				echo '<h3 class="ui-li-heading">';
				echo '<a class="ui-link-inherit" data-transition="slide" href="profile.php?u='.$r['uid'].'">';
				echo $r['username'];
				echo '</a></h3>';
